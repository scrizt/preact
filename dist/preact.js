!function() {
    ...
    function diff(dom, vnode, context, mountAll, parent, componentRoot) {
        ...
        try {
            ...
            diffLevel--;
            hydrating = diffLevel ? hydrating : !1;
        }
        if (!diffLevel) if (!componentRoot) flushMounts();
        return ret;
    }
    ...
    function recycle(component, base) {
        component.__b = base;
        recyclerComponents.push(component);
    }
    function reclaimRecycledBase(componentCtor) {
        var i = recyclerComponents.length;
        while (i--) if (recyclerComponents[i].constructor === componentCtor) {
            var base = recyclerComponents[i].__b;
